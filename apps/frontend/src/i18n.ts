...
const resources = {
  en: {
    translation: {
      ...
      'cardDetail.deepDive': 'Deep Dive',
      'deepDive.title': 'AI Deep Dive',
      'deepDive.question': 'Your question',
      'deepDive.placeholder': 'Ask anything about this condition…',
      'deepDive.ask': 'Ask',
      'deepDive.answer': 'Answer',
      'deepDive.close': 'Close',
      'deepDive.error': 'Something went wrong.',
    },
  },
  hi: {
    translation: {
